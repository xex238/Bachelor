...
GLfloat ctlarray1[3][2][4] = { 0.5, 0.0, -0.5, 1.0, 
                              0.5, 0.0, 0.5, 1.0, 
	                          0.0, sqrt(3)*0.5*0.5, -0.5*0.5, 1.0*0.5,
	                          0.0, sqrt(3)*0.5*0.5,  0.5*0.5, 1.0*0.5,
	                          -0.5, 0.0, -0.5, 1.0, 
	                          -0.5, 0.0, 0.5, 1.0 };
...
void Display() {
	...
	gluNurbsSurface(thenurb, 6, knot, 4, knot1, 2 * 4, 4, &ctlarray1[0][0][0], 3, 2, GL_MAP2_VERTEX_4);
